class EventsManager {
    ...
    obtenerDataInicial() {
      ...
      form_data.append('username', localStorage.getItem('username'));
        let url = 'http://localhost/PHP/server/getEvents.php'
    ...
    anadirEvento(){
      ...
      $.ajax({
        url: 'http://localhost/PHP/server/new_event.php',
        dataType: "json",
        cache: false,
        processData: false,
        contentType: false,
...
function eliminarEvento(event, jsEvent){
  ...
  $.ajax({
    url: 'http://localhost/PHP/server/delete_event.php',
    dataType: "json",
    cache: false,
    processData: false,
    contentType: false,
...
function actualizarEvento(evento) {
    ...
    $.ajax({
      url: 'http://localhost/PHP/server/update_event.php',
      dataType: "json",
      cache: false,
      processData: false,
      contentType: false,
...
function poblarCalendario(events) {
  var listEvents = [];
